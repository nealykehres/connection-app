(function() {
    ...
    *************************************************************************/
    var RESULTS_FOLDER_URL = "http://www.example.com/a_folder/";
    ...
    *************************************************************************/
    var TRAIT_PAIRS = [["urban", "rural"], ["lessthan55", "morethan55"],  ["onetothree", "fourormore"], ["yes", "no"]];
    ...
    *************************************************************************/
    ...
    RESULTS["rural&morethan55&fourormore&yes"] = {
        name: "Windstream",
        image: "result_1.jpg",
        text: "Text for the first result"
    };

    RESULTS["rural&morethan55&fourormore&no"] = {
        name: "Dish",
        image: "result_2.jpg",
        text: "Text for the second result"
    };

    RESULTS["rural&morethan55&onetothree&yes"] = {
        name: "Windstream",
        image: "result_3.jpg",
        text: "Text for the third result"
    };

    RESULTS["rural&morethan55&onetothree&no"] = {
        name: "Dish",
        image: "result_4.jpg",
        text: "Text for the fourth result"
    };

    RESULTS["rural&lessthan55&fourormore&yes"] = {
        name: "Windstream",
        image: "result_4.jpg",
        text: "Text for the fourth result"
          };

    RESULTS["rural&lessthan55&fourormore&no"] = {
            name: "Hotspot",
            image: "result_4.jpg",
            text: "Text for the fourth result"
  };
    RESULTS["rural&lessthan55&onetothree&yes"] = {
            name: "Windstream",
            image: "result_4.jpg",
            text: "Text for the fourth result"
  };
    RESULTS["rural&lessthan55&onetothree&no"] = {
            name: "Hotspot",
            image: "result_4.jpg",
            text: "Text for the fourth result"
  };
    RESULTS["urban&morethan55&fourormore&yes"] = {
            name: "AT&T",
            image: "result_4.jpg",
            text: "Text for the fourth result"
  };
    RESULTS["urban&morethan55&fourormore&no"] = {
           name: "COX",
           image: "result_4.jpg",
           text: "Text for the fourth result"
  };
   RESULTS["urban&morethan55&onetothree&yes"] = {
          name: "AT&T",
         image: "result_4.jpg",
        text: "Text for the fourth result"
  };
  RESULTS["urban&morethan55&onetothree&no"] = {
          name: "COX",
          image: "result_4.jpg",
          text: "Text for the fourth result"
  };
  RESULTS["urban&lessthan55&fourormore&yes"] = {
            name: "AT&T",
            image: "result_4.jpg",
            text: "Text for the fourth result"
  };
    RESULTS["urban&lessthan55&fourormore&no"] = {
              name: "COX",
              image: "result_4.jpg",
              text: "Text for the fourth result"
  };
     RESULTS["urban&lessthan55&onetothree&yes"] = {
              name: "AT&T",
              image: "result_4.jpg",
              text: "Text for the fourth result"
  };
     RESULTS["urban&lessthan55&onetothree&no"] = {
               name: "Hotspot",
               image: "result_4.jpg",
               text: "Text for the fourth result"
             }
