//this code was adapted from https://codepen.io/jannypie/pen/DcHdo/

// Quiz result options in a separate object for flexibility
var resultOptions = [
    {   title: 'AT&T',
        desc: '<p>AT&T might be a good option for you.</p>'},
    {   title: 'COX',
        desc: '<p>COX might be a good option for you.</p>'},
    {   title: 'Dish',
        desc: '<p>Dish might be a good option for you.</p>'},
    {   title: 'Internet Hotspot',
        desc: '<p>Using an internet hotspot might be a good option for you.</p>'},
    {   title: 'Windstream',
        desc: '<p>Windstream might be a good option for you.</p>'}
];
